...
function PlannerShell() {
  ...
  return (
    <div className="flex h-dvh overflow-hidden">
      ...
      {/* Main content area */}
      <main className="flex-1 flex flex-col min-w-0 paper-grain bg-surface pb-16 md:pb-0">
        <AppHeader
      ...
      {/* Mobile bottom nav */}
      <nav
        className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-surface-dim flex py-1.5"
        role="navigation"
